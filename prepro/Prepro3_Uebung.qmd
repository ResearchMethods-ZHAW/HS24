...
Erstelle nun eine *convenience Variable* für die Kalenderwoche pro Messung (`lubridate::week`). Berechne im Anschluss den mittleren Temperaturwert pro Kalenderwoche.
