...
- Im Rahmen unserer Analyse programmieren wir multivariate Modelle, welche den Zusammenhang zwischen der Anzahl Besuchenden und verschiedenen Einflussfaktoren beschreiben. Dank den Modellen können wir sagen, wie die Besucher:innen auf die untersuchten Faktoren reagiert haben (siehe dazu auch euren Forschungsplan).
...
- Da Wildtiere wie z. B. Rehe besonders Dämmerungs- und Nachtaktiv sind, ist diese Tageszeit bei unseren Auswertungen speziell im Fokus.
