...
1. Zähldaten zu eurem Standort (211_sihlwaldstrasse_2017_2024.csv, 502_sihluferweg_2016_2024.csv)
2. Meteodaten (order_105742_data.txt) und Legende
...
2. Werktag oder Wochenende als Faktor. 
...
- Die Stundendaten werden zu ganzen Tagen aggregiert. Bezieht folgende Gruppierungen (__group_by()__) mit ein: __Datum, Wochentag, Wochenende, KW, Monat, Jahr, Phase__. Summiert die Zählmengen separat (Total, IN, OUT) auf und speichert das Resultat unter __depo_d__ ("_d" für "day").

Tipp: Wenn man die Convenience Variablen als grouping variable einspeisst, dann werden sie in das neue df übernommen und müssen nicht nochmals hinzugefügt werden
