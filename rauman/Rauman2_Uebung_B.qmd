...
```{r}
#| output: true
#| fig-cap: Hangneigung des Kantons Schwyz (`v = "slope"`)
...
```{r}
#| output: true
#| fig-cap: Hangausrichtung des Kantons Schwyz (`v = "aspect"`). Hier wurde eine eigene Farbpalette erstellt, da sich die Extremwerte 0 und 360 (*Norden*) sich farblich nicht unterscheiden sollten.
...
```{r}
#| output: true
#| fig-cap: Für diese Visualisierung verwende ich `tmap` und als die Farbpalette `values = "matplotlib.cividis"`.
